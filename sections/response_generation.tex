...
\begin{figure}
  \centering
  \subfloat[Lottery FSM]{\includegraphics[scale=0.50]{rules_lottery.png}}
  ~ %add desired spacing between images, e. g. ~, \quad, \qquad etc. (or a blank line to force the subfig onto a new line)
  \subfloat[Snippet FSM]{\includegraphics[scale=0.50]{pfsm_text_snippet.png}}
  ~ %add desired spacing between images, e. g. ~, \quad, \qquad etc. (or a blank line to force the subfig onto a new line)
