...
[Figure] shows the distribution of incoming scam instances over the 10-day period. The five most common classes are: \texit{Loans, Romance, Next of kin, Lottery, Business}.
...
\begin{tabular}{l c c}
  \hline
  \textbf{\textbf{Class}} & \textbf{\# encounters} & \textbf{Avg. \# words in class} \\
  \hline
ATM card & 7 & 605.86 \\ 
Employment & 0 & -- \\ 
