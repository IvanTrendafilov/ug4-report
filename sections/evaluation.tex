...
\begin{tabular}{l c c}
  \hline
  \textbf{Measure} & \textbf{Score} & \textbf{Avg. \# words} \\
  \hline
  Absolute avg. thread length & 3.80 & 2145.58 \\
  Avg. thread length, existing only & 4.75 & 2123.27 \\
  Avg. thread length, participating only & 6.20 & 2179.77 \\
  Human respondent, participating only* & 7.40 & 2253.10 \\
  \hline
\end{tabular}
}
\end{center}
