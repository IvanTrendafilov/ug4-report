\abstract{In this project we explore the feasibility of building a conversational agent to sustain email correspondence with advance fee fraud (AFF) spammers. AFF spam is a type of
unsolicited email, in which the scammer attempts to extract large sums of money
from a target using various social engineering techniques. Because these messages resemble legitimate correspondence, they are often omitted by modern spam filters.
